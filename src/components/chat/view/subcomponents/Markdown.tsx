...
// re-render. `Markdown`'s only inputs are `children`/`className`/`breaks` plus
// the stable `openFileInEditor` from context, so shallow prop comparison is a
// safe guard that stops the whole tree from re-parsing when content is unchanged.
